...
const server = net.createServer((connection) => {
  ...
  connection.on("data", (clientInput)=>{
    ...
    if(psync){
      ...
      const hexfile = ""
      const hexFileArray = hexfile.match(/../g)
      const binaryFile = hexFileArray.map(e=>parseInt(e,16).toString(2).padStart(8,'0'))
